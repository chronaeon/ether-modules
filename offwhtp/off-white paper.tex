...
\end{longtable}
	...
	\hline
		...
		0x40 & BLOCKHASH & 20 & 1 & 1 & Get the hash of one of the 256 most recent blocks. A value of 0 is left on the stack if the block number is more than 256 in number behind the current one, or if it is a number greater than the current one.} \\ 
