...
%---MY CUSTOM COMMANDS---%
\newcommand{\ii}[0]{\tiny{ii}}
\newcommand{\is}[0]{\tiny{is}}
\newcommand{\ei}[0]{\tiny{ei}}
\newcommand{\es}[0]{\tiny{es}}
\newcommand{\dd}[0]{\tiny{--}}
\newcommand{\nr}[0]{\scriptsize{\textsc{nr}}}

\newcommand{\add}[0]{\tiny{add}}
\newcommand{\sub}[0]{\tiny{sbn}}
\newcommand{\gmr}[0]{\tiny{gmr}}
\newcommand{\dfs}[0]{\tiny{dfs}}
\newcommand{\abs}[0]{\tiny{abs}}
\newcommand{\idx}[0]{\tiny{idx}}
\newcommand{\dia}[0]{\tiny{dia}}

\newcommand{\iis}[0]{\scriptsize{\sl{II}}}
\newcommand{\eis}[0]{\scriptsize{\sl{EI}}}
\newcommand{\iss}[0]{\scriptsize{\sl{IS}}}
\newcommand{\ess}[0]{\scriptsize{\sl{ES}}}
\newcommand{\adds}[0]{\scriptsize{add}}
\newcommand{\subs}[0]{\scriptsize{sub}}
\newcommand{\gmrs}[0]{\scriptsize{gmr}}
\newcommand{\dfss}[0]{\scriptsize{dfs}}
\newcommand{\abss}[0]{\scriptsize{abs}}
\newcommand{\idxs}[0]{\scriptsize{idx}}
\newcommand{\dias}[0]{\scriptsize{dia}}
...
%---HEADER SETTINGS---%
  \setlength{\headheight}{15pt} % Increase the size of the header to accommodate meta info.
    ...
    \fancyhead[L]{\today}
    \fancyhead[C]{\textit{Offwhitepapers} Modular Specifications for Ethereum \space}
    ...
    \title{\Huge {Offwhitepapers} \\ \hfill \\ \Large{Offwhitepapers}}
...
Thanks to the founders of Ethereum for making a product worth writing about, thanks to the ConsenSys Mesh for reviewing and contributing to the creation of this work, and thanks to Dr. Gavin Wood for going above and beyond in expressing the political, philosophical, cultural, and contractual implications for Ethereum in his Yellowpaper.
...
\clearpage
	  ...
	  \section{Preface}Ethereum's formal specification, \textit{The Yellowpaper}, goes above and beyond the understanding of most lay-readers. With a plethora of astute formal proofs, its author offers nothing short of Newton's \textit{Principia} for Distributed Ledger Technology. Although most readers of the Yellowpaper can only partially appreciate the depth of Dr. Wood's understanding, since the paper is written as a historical memoir but contains its own character set unique formal structure. Admittedly, the difficulty of learning Ethereum's inner workings is not small, but it's made unnecessarily complicated if readers have to learn an array of incumbent symbols at the same time. 
\par
